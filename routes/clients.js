...
const { createClient, updateClient, removeClient, getClientDetail, getAllClients, getClientWithSearchAndPaging, createClientAccounts } = require("../controllers/clients");
